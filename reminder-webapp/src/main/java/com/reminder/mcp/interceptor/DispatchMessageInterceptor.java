...
import static com.reminder.mcp.model.DispatchInterceptorConstant.*;
...
public class DispatchMessageInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,
        ...
        if (cmn == null) {// no class name
            ...
            if (paramParse.getResponseModel() != null) {
                ResponseWriter.writeErrResponse(response, paramParse
                        .getResponseModel().getCode(), paramParse.getResponseModel().getResult());
                return false;
            }
...
//            }
            ...
            ResponseModel mcp = new ResponseModel(ACK_OK,ret);
...
//            	if(r.getCode() != ResultConstant.OP_SUCC){
//            		mcp.setCode(r.getCode());
//                }
//            	else{
//            		mcp.setCode(ACK_OK);
//                }
//                mcp.setResult(((McpInteger) ret).getRet());
//            }else{
//
//                mcp.setCode(ACK_OK);
//                mcp.setResult(ret);

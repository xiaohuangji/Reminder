package com.reminder.redis.pool;
...
public class RedisPoolFactory {
	...
	public RedisPoolFactory(){
        ...
        InputStream fis =this.getClass().getClassLoader().getResourceAsStream("redis.properties");
        try{
            prop.load(fis);
            redisServer=prop.getProperty("redis_server");
            initRedisServerList();
        }catch(Exception e){
